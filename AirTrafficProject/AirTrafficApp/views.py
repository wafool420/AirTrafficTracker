...
def archive_view(request):
    if request.method == "GET":
        ...
        for group in archive:
            ...
            group.movement_overall_total = (
                group.arrival_total +
                group.departure_total +
                group.enroute_total
            )
            ...
            group.timeliness_overall_total = (
                group.delayed_total +
                group.ontime_total +
                group.na_total
            )
            ...
            group.genav_birdstrike_total = group.genav_arrival_birdstrike + group.genav_departure_birdstrike + group.genav_enroute_birdstrike
            ...
            group.military_birdstrike_total = group.military_arrival_birdstrike + group.military_departure_birdstrike + group.military_enroute_birdstrike
            ...
            group.birdstrike_overall_total = (
                group.arrival_total_birdstrike +
                group.departure_total_birdstrike +
                group.enroute_total_birdstrike
            )
            ...
            # Total Runway Intrusion Counts for Each Movement Type
            group.arrival_total_runwayintrusion = (
                group.commercial_arrival_runwayintrusion +
                group.genav_arrival_runwayintrusion +
                group.military_arrival_runwayintrusion
            )

            group.departure_total_runwayintrusion = (
                group.commercial_departure_runwayintrusion +
                group.genav_departure_runwayintrusion +
                group.military_departure_runwayintrusion
            )

            group.enroute_total_runwayintrusion = (
                group.commercial_enroute_runwayintrusion +
                group.genav_enroute_runwayintrusion +
                group.military_enroute_runwayintrusion
            )
            group.runwayintrusion_overall_total = (
                group.arrival_total_runwayintrusion +
                group.departure_total_runwayintrusion +
                group.enroute_total_runwayintrusion
            )
            ...
            # GenAv Totals for All Categories
